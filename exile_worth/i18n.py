...
'en': {
    ...
    'note.unknown_icon': 'Item not recognised. You can identify it in the Corrections tab.',
    'note.variant': 'Item recognised, but not its tier. You can confirm it in the Corrections tab.',
...
'fr': {
    ...
    'note.unknown_icon': 'Objet non reconnu. Tu peux l’identifier dans l’onglet Corrections.',
    'note.variant': 'Objet reconnu, mais pas son palier. Tu peux le confirmer dans l’onglet Corrections.',
