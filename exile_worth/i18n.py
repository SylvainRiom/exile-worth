...
'en': {
    ...
    'link.why': 'Not linked to a tab: {reason}',
    'link.unknown': 'this tab could not be recognised.',
    'link.icons_only': 'Its type was guessed from the items only, so it cannot be linked by itself.',
    'link.no_layout': 'Type not recognised: choose it in the type menu at the top right to link this tab.',
    'link.choose': 'This is the tab:',
    'link.new': 'A new tab…',
    'link.button': 'Link',
    'link.pick': 'Choose the tab this reading belongs to.',
    'link.new_title': 'New tab',
    'link.new_prompt': 'Name of this tab, as in the game:',
    'link.done': '“{name}” linked: it updates from this screenshot on.',
    'link.no_tab_bar': 'The selected tab cannot be seen in the tab bar: keep the stash tab bar visible.',
    'link.other_type': '“{name}” is a stash of another type: choose a tab of the type shown.',
    'gains.title_open': 'Session since {start}: {total:+,.2f} div over {count} item(s) that changed, at the latest prices',
    'gains.title_done': 'Last session, {start} to {end}: {total:+,.2f} div over {count} item(s) that changed, at its end prices',
    'gains.none': 'No item changed during this session.',
    'gains.col_item': 'Item',
    'gains.col_before': 'At the start',
    'gains.col_after': 'At the end',
    'gains.col_change': 'Change',
    'gains.col_value': 'Value',
    'guide.title': 'Getting started',
    'guide.window': '1. Play in borderless windowed mode at 1920×1080. Other resolutions and interface scales are not supported yet.',
    'guide.stash': '2. Open your stash in the game and keep its tab bar visible.',
    'guide.start': '3. Click Start, then go back to the game. Each supported tab you open is recognised, added to this list and kept up to date.',
    'guide.link': 'If a tab stays in the live preview, the reason shows under its title and you can link it by hand.',
    'guide.close': 'Got it',
    ...
    'chart.since': 'since {time}, every tab read',
...
'fr': {
    ...
    'link.why': 'Pas relié à un onglet : {reason}',
    'link.unknown': 'cet onglet n’a pas pu être reconnu.',
    'link.icons_only': 'Son type n’a été deviné que par les objets, il ne peut donc pas être relié tout seul.',
    'link.no_layout': 'Type non reconnu : choisis-le dans le menu des types en haut à droite pour relier cet onglet.',
    'link.choose': 'C’est l’onglet :',
    'link.new': 'Un nouvel onglet…',
    'link.button': 'Relier',
    'link.pick': 'Choisis l’onglet auquel appartient cette lecture.',
    'link.new_title': 'Nouvel onglet',
    'link.new_prompt': 'Nom de cet onglet, comme dans le jeu :',
    'link.done': '« {name} » relié : il se met à jour à partir de cette capture.',
    'link.no_tab_bar': 'L’onglet sélectionné n’est pas visible dans la barre d’onglets : garde-la visible.',
    'link.other_type': '« {name} » est un coffre d’un autre type : choisis un onglet du type affiché.',
    'gains.title_open': 'Session depuis {start} : {total:+,.2f} div sur {count} objet(s) qui ont changé, aux derniers prix',
    'gains.title_done': 'Dernière session, de {start} à {end} : {total:+,.2f} div sur {count} objet(s) qui ont changé, aux prix de la fin',
    'gains.none': 'Aucun objet n’a changé pendant cette session.',
    'gains.col_item': 'Objet',
    'gains.col_before': 'Au début',
    'gains.col_after': 'À la fin',
    'gains.col_change': 'Écart',
    'gains.col_value': 'Valeur',
    'guide.title': 'Pour commencer',
    'guide.window': '1. Joue en fenêtré sans bordure, en 1920×1080. Les autres résolutions et échelles d’interface ne sont pas encore prises en charge.',
    'guide.stash': '2. Ouvre ton coffre dans le jeu et garde sa barre d’onglets visible.',
    'guide.start': '3. Clique sur Démarrer, puis reviens dans le jeu. Chaque onglet pris en charge que tu ouvres est reconnu, ajouté à cette liste et tenu à jour.',
    'guide.link': 'Si un onglet reste dans l’aperçu en direct, la raison s’affiche sous son titre et tu peux le relier à la main.',
    'guide.close': 'Compris',
    ...
    'chart.since': 'depuis le {time}, tous les onglets lus',
